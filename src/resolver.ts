import { Literal, Grouping, Unary, Binary, Expr, Assign, Visitor as ExpresionVisitor, Variable, Logical, Call, Get, ExprSet, This, ExprSuper } from "./expr";
...
export default class Resolver implements StatementVisitor, ExpresionVisitor {
  ...
  visitClass(stmt: Class) {
    ...
    if (stmt.superclass !== null && stmt.superclass.name.getLexeme() === stmt.name.getLexeme()) {
